...
#numind = 4
print(numind)
# I do not consider rows with fiscal years less than 2000 and greater than the last complete fiscal year (2022)
datay = data.loc[( (data['fiscalmonth']==12) & (data['yearf']>1999) & (data['yearf']<2023))].copy()
...
Now, the equation for large firm: For large firms, sizeg_medium=0 and sizeg_large=0, then: 
