...
$$
E[f1ry] = (0.0613+0.0383) +(0.6519-0.1950)(oepspw)-0.1265(bmrw)-0.0071(revgrowthw)-0.0015(egrowthw)+(0.0021)pmw-0.0219(atow)
E[f1ry] = (0.0996) +(0.4569)(oepspw)-0.1265(bmrw)-0.0071(revgrowthw)-0.0015(egrowthw)+(0.0021)pmw-0.0219(atow)

$$
Compared to the equation for small firms, the equation for medium firms had a higher intercept (beta0=0.0996), and the oepspw beta coefficient decreased from 0.6519 to 0.4569 (b1=0.4569). 
Then, compared to medium firms, small firms have a significant higher effect of oepsw on future stock returns.

Now, the equation for large firm:
For large firms, sizeg_medium=0 and sizeg_large=0, then:
$$
E[f1ry] = (0.0613+0.1140) +(0.6519-0.8432)(oepspw)-0.1265(bmrw)-0.0071(revgrowthw)-0.0015(egrowthw)+(0.0021)pmw-0.0219(atow)
E[f1ry] = (0.1753) + (-0.1913)(oepspw)-0.1265(bmrw)-0.0071(revgrowthw)-0.0015(egrowthw)+(0.0021)pmw-0.0219(atow)
