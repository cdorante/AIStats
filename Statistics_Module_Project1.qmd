...
-   (optional) For each independent variable you have to check for outliers (extreme values) and if it is necessary do the corresponding adjustments with winsorization to avoid unreliable results in your regression model

-   Once you corrected your variables for outliers (in case you did it) and addressed possible multicollienarity problems, run a final multiple regression model
