...
#gspc = pdr.get_data_yahoo('^GSPC', start=date(2010, 1, 1), interval='d')
#sp500 = pdr.get_data_yahoo('^GSPC', start="01/01/2009", interval='d')
sp500 = pdr.get_data_yahoo('^GSPC', start=date(2009,1,1), end=date(2022,9,30), interval='d')

# I keep the adj close column:
sp500 = pd.Series(sp500['Adj Close'])
sp500
