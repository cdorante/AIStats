...
abstract: In this workshop we start learning about the Simple Linear Regression Model.
...
I will not derive here the formulas for the expected standard deviation of the beta coefficients, but you can check this derivation in the Appendix of my note: [**Basics of Linear Regression Models in the context of Finance**](https://docs.google.com/viewer?a=v&pid=sites&srcid=ZWdhZGVyemMubmV0fGVjMjAwM3xneDozMjA2YmVjYjZjMmVjODA5)
